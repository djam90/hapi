...
class TimeZone
{
     ...
     */
    const ATLANTIC_TIME = "Atlantic Time (Canada)";
     ...
     *  Cape Verde Is.
     */
    const CAPE_VERDE_IS = "Cape Verde Is.";
     ...
     */
    const INTERNATIONAL_DATE_LINE_WEST = "International Date Line West";
